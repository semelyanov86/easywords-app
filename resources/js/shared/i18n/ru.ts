...
export const translations: TranslationStructure = {
    ...
    words: {
        ...
        extract_from_image_title: 'Добавить из изображения',
        extract_from_image_description:
            'Загрузите изображение с текстом и получите список слов для изучения с переводами.',
        back_to_create: 'Назад к добавлению слова',
        upload_image_title: 'Загрузить изображение',
        upload_image_description:
            'Выберите изображение с текстом на одном из поддерживаемых языков.',
        select_image: 'Выберите изображение',
        source_language: 'Язык текста на изображении',
        target_language: 'Язык перевода',
        processing: 'Обработка...',
        extract_words: 'Извлечь слова',
        extracted_words_title: 'Извлеченные слова',
        extracted_words_description:
            'Нажмите кнопку «Добавить слово», чтобы сохранить слово в словарь.',
        original: 'Оригинал',
        translation: 'Перевод',
        language: 'Язык',
        actions: 'Действия',
