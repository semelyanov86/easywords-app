...
export const translations: TranslationStructure = {
    ...
    settings: {
        ...
        importing: 'Импорт...',
        fields: {
            paginate: 'Количество карточек для изучения',
            main_language: 'Язык изучения по умолчанию',
            show_starred: 'Показывать только избранное',
            known_enabled: 'Показывать уже изученные',
            latest_first: 'Выборка по свежедобавленным словам',
            show_imported: 'Показывать импортированные слова',
            show_shared:
                'Показывать слова, с которыми поделились другие пользователи',
